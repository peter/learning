...
# DATE_PARTITION=2025-09-09 clickhouse-ingestion-test.py | jq
...
BQ_TABLE_NAME = os.getenv(
    "BQ_TABLE_NAME", "mercurial-idiom-218413.insights_dwh.tracker_attention_scores_agg"
)
CLICKHOUSE_TABLE_NAME = os.getenv(
    "CLICKHOUSE_TABLE_NAME", "tracker_attention_scores_agg"
)
